...
unsafe fn check_posix_memalign(instance: &mut Instance, outptr: u32, size: u32) -> Result<u32> {
    for (_, entry) in instance.exports() {
        if let wasmtime_environ::EntityIndex::Memory(mem_index) = entry {
            ...
            let b0 = *mem.base.offset(outptr as isize + 0) as u32;
            let b1 = *mem.base.offset(outptr as isize + 1) as u32;
            let b2 = *mem.base.offset(outptr as isize + 2) as u32;
            let b3 = *mem.base.offset(outptr as isize + 3) as u32;
